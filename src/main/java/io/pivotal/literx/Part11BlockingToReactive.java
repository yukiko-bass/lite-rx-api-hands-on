...
/**
 * Learn how to call blocking code from Reactive one with adapted concurrency
 * strategy for
...
public class Part11BlockingToReactive {
	...
	// deferred until the flux is subscribed, and run it with a bounded elastic
	// scheduler
	...
	// using a bounded elastic scheduler and return a Mono<Void> that signal the end
	// of the operation
